...
# Cambiar a la rama con Tailwind (o usar main para CSS custom)
git checkout tailwind-version
...
- **`main`**: Versión original con CSS personalizado
- **`tailwind-version`**: Versión con Tailwind CSS integrado

Ambas versiones son totalmente funcionales y cumplen con todos los requisitos.
